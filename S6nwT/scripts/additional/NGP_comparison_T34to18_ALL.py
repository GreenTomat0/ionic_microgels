...
def draw_NGP():
	...
	markers = ['o', 'v', '*', '.', 'h', '<',]
	colors = ['black', 'dimgray', 'gray', 'black', 'dimgray', 'gray']
	...
	for i, (t, n) in enumerate(zip(tau_sp, NGP_sp)):
		...
		plt.plot(t, n, ls='none', ms=10, markerfacecolor="None", markeredgewidth=2, marker=markers[counter], color=colors[counter],
			label=str(time_label) + ' min')
	...
	# plt.savefig("/Users/miroshni/Documents/Unifr/Unifr_work/glass_transition_in_emulsions/TrackPy/microgels/feb20/our_article/images/NGP_temperature.svg", format='svg')
	# plt.savefig("/Users/miroshni/Documents/Unifr/Unifr_work/glass_transition_in_emulsions/TrackPy/microgels/feb20/our_article/images/NGP_temperature.png", format='png')
...
def draw_MSD():
	...
	markers = ['o', 'v', '*', '.', '<', 'h']
	colors = colors = ['black', 'dimgray', 'gray', 'black', 'gray', 'dimgray']
	...
	for s in series:
		...
		for fr in frame_range:
			...
			plt.plot(tau, MSD_micron, ls='none', ms=10, markerfacecolor="None", markeredgewidth=2, marker=markers[counter], color=colors[counter],
				label=str(time_label) + ' min')
		...
		# plt.savefig("/Users/miroshni/Documents/Unifr/Unifr_work/glass_transition_in_emulsions/TrackPy/microgels/feb20/our_article/images/MSD_temperature.svg", format='svg')
		# plt.savefig("/Users/miroshni/Documents/Unifr/Unifr_work/glass_transition_in_emulsions/TrackPy/microgels/feb20/our_article/images/MSD_temperature.png", format='png')
